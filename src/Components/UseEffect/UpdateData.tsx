...
const UpdateData = () => {
    ...
    const FetchData = () => {
        setIsLoading(true);
        apiClient.get(`https://jsonplaceholder.typicode.com/${endpoints[category]}`)
            .then(response => {
    ...
    const handleUpdate = () => {
        if (editingUser) {
            ...
            apiClient.put(`https://jsonplaceholder.typicode.com/users/${editingUser.id}`, updatedUser)
                .then(response => {
    ...
    const updateUser= (user:User) => {
        const updatedUser = {...user, username: user.username +"!"};
                    ...
                    {users.map(user =>
                        <li className="list-group-item d-flex justify-content-between" key={user.id}>
                            ...
                            <div>
                                ...
                                <button onClick={() => updateUser(user)} className="btn btn-outline-danger">Update</button>
